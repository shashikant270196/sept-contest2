...
// function renderStudent1(){
//     students.map((student)=>{
//         const name1 = `${student.first_name} ${student.last_name}`;
//         console.log(name1);
//     }
...
// let userFullnames = students.map((student) => {
...
function renderStudent() {
    ...
    students.forEach((student) => {
        ...
        const columns = ["id", "first_name", "gender", "class", "marks", "email"];
        columns.map((column) => {
